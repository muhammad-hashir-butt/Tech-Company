      ...
      <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            >
              <motion.h3 
                className="text-3xl font-bold mb-4 bg-gradient-to-r from-sky-400 to-indigo-400 bg-clip-text text-transparent"
                whileHover={{ scale: 1.05 }}
              >
                CloudSolutions
              </motion.h3>
              <p className="text-gray-400 leading-relaxed mb-6">
                Empowering businesses with enterprise-grade cloud infrastructure and expert migration services.
              </p>
              <div className="flex gap-4">
                {[
                  ...
                  <motion.a
                    key={i}
                    href={social.link}
                    className="w-12 h-12 rounded-full bg-gradient-to-br from-sky-600 to-indigo-500 flex items-center justify-center text-2xl hover:shadow-lg hover:shadow-sky-500/50 transition-all"
            ...
            >
              <h4 className="text-xl font-bold mb-6 text-sky-400">Services</h4>
              <ul className="space-y-3">
                {["Cloud Migration", "Infrastructure as Code", "Container Orchestration", "Serverless", "Cloud Security", "DevOps & CI/CD"].map((service, i) => (
                  <motion.li 
                    key={i}
                    whileHover={{ x: 5 }}
            ...
            >
              <h4 className="text-xl font-bold mb-6 text-sky-400">Get In Touch</h4>
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-400">
                  <span className="text-2xl">📧</span>
                  <div>
                    <p className="text-sm text-gray-500">Email</p>
                    <a href="mailto:hello@cloudsolutions.com" className="hover:text-sky-400 transition-colors">
                      hello@cloudsolutions.com
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3 text-gray-400">
          ...
          >
            <p className="text-gray-400 text-sm">
              © 2026 CloudSolutions. All rights reserved. Powered by AWS, Azure & Google Cloud.
            </p>
