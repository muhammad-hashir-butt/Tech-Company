        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Building world-class mobile applications that transform ideas into reality and delight millions of users.
              </p>
              <div className="flex gap-4">
                {[
                  ...
                  <motion.a
                    key={i}
                    href={social.link}
                    className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-600 to-pink-500 flex items-center justify-center text-2xl hover:shadow-lg hover:shadow-purple-500/50 transition-all"
            ...
            >
              <h4 className="text-xl font-bold mb-6 text-pink-400">Services</h4>
              <ul className="space-y-3">
                {["iOS Development", "Android Development", "Cross-Platform Apps", "Progressive Web Apps", "App Modernization", "Enterprise Solutions"].map((service, i) => (
                  <motion.li 
                    key={i}
                    whileHover={{ x: 5 }}
            ...
            >
              <h4 className="text-xl font-bold mb-6 text-pink-400">Get In Touch</h4>
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-400">
                  <span className="text-2xl">📧</span>
                  <div>
                    <p className="text-sm text-gray-500">Email</p>
                    <a href="mailto:hello@mobileapppro.com" className="hover:text-pink-400 transition-colors">
                      hello@mobileapppro.com
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3 text-gray-400">
          ...
          >
            <p className="text-gray-400 text-sm">
              © 2026 MobileApp Pro. All rights reserved. Built with ❤️ and React Native.
            </p>
